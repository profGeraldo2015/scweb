...
public class Relatorio3 {
    ...
    public List<Tlinha> extrato(String opcao, String conta, String DATAI, String DATAF) throws SQLException {

        List<Tlinha> extrato = new ArrayList();
        ...
        SAL_ANT = SALDO_CONTA;
        System.out.println("saldo inicial "+SAL_ANT);
        ...
        System.out.println("saldo inicial w dt saldo  "+W_DT_SALDO + " saldo "+SALDO);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getDate("dt_vencto").before(CtoD(DATAI))) {
                    ...
                    if (!CtoD(this.getATUAL()).equals(rs.getDate("dt_vencto"))) {
                        SALDO = SAL_ANT;
                        System.out.println("saldo "+SALDO +" SAL_ANT "+SAL_ANT);
                    }
            ...
            SALDO = SAL_ANT;
            System.out.println("saldo inicial SAL_ANT "+SAL_ANT);
        ...
        Tlinha linha = new Tlinha();
        linha.setTipo("h1");
        linha.setContent(" CONTA : " + conta + " - " + saldo_inicial.getDescricao() + " com vencimento de "
        ...
        Tlinha linha2 = new Tlinha();
        linha2.setTipo("h2");
        linha2.setContent(" Saldo inicial em "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (!CtoD(getATUAL()).equals(li.getVencimento())) {
                    if (flag == true) {
                        Tlinha linha3 = new Tlinha();
                        linha3.setTipo("d2");
                        linha3.setContent(formatar(" >>> SALDO >>> " + data.format(CtoD(getATUAL())) + " " + df.format(SALDO)));
                        extrato.add(linha3);
                ...
                Tlinha linha4 = new Tlinha();
                linha4.setTipo("d1");
                linha4.setContent(data.format(li.getEmissao()) + " | "
                        + li.getDebito() + " | "
                        + li.getCredito() + " | "
                        + data.format(li.getVencimento()) + " | "
                        + formatar(li.getHistorico(), "d"));
                extrato.add(linha4);
                System.out.println(linha4);
                Tlinha linha5 = new Tlinha();
                linha5.setTipo("d2");
                linha5.setContent(formatar(li.getObs(), "d")
                        + formatar(df.format(li.getValor())+ tipo, "e"));
        ...
        Tlinha linha6 = new Tlinha();
        linha6.setTipo("f1");
        linha6.setContent(">>>  Creditos " + df.format(DEBITO) + " <<<  >>>  Debitos " + df.format(CREDITO) + " <<< >>> Saldo final : " + df.format(SALDO));
        extrato.add(linha6);
